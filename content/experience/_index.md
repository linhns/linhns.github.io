...
I developed and maintained software features for several robotic fusion biopsy machines
manufactured and distributed by the company, mainly using C++, Qt and obscure
APIs.

Also wore the hat of a DevOps engineer in parts as I improved the internal CI/CD
pipelines.

#### Software Engineer Intern at Omron Asia Pacific

I was responsible for building robotic applications for Omron's slate
of industrial robots, including autonomous mobile robot (AMR) and robotic arm.
I mainly worked with ROS2.

I programmed and tested an integration of Omron AMRs with the
[Robotics Middleware Framework](https://github.com/open-rmf/rmf_demos).
